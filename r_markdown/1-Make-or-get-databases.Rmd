...
Note that all of these databases can also be downloaded from [Dropbox](https://www.dropbox.com/sh/lvlz2wpsssvsrad/AAC-BkJja8LvlDoNDB4qgnHNa?dl=0).
...
To do this with the least amount of steps/downloads possible, I follow the instructions for making the GTDB + NCBI database first, in Make-custom-Kraken2-database.md.<br>
